<template>
  <Teleport to="body">
    ...
    <Transition name="fade" mode="out-in">
      <div v-show="webSiteStore.mobileMenuShow" class="mobile-menu">
        <!-- 背景遮罩 -->
        <div class="menu-mask" @click="webSiteStore.changeShowStatus('mobileMenuShow')" />
        <Transition name="toLeft" mode="out-in">
          <div v-show="webSiteStore.mobileMenuShow" class="menu-content s-card">
            <!-- 关闭按钮 -->
            <div class="close-control" @click="webSiteStore.changeShowStatus('mobileMenuShow')">
...
const pageJump = (url) => {
  if (!url) return false;
  webSiteStore.changeShowStatus("mobileMenuShow");
  router.go(url);
};
</script>
